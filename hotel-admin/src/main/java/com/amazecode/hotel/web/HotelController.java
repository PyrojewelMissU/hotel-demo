...
public class HotelController {
    ...
    public void updateById(@RequestBody Hotel hotel) {
        ...
        //发送消息，提醒消费者更新ES中的数据,发送消息的消息体尽量小一点,避免队列被占满
        System.out.println("=== [hotel-admin] 准备发送MQ消息 ===");
        System.out.println("交换机: " + MqConstants.HOTEL_EXCHANGE);
        System.out.println("路由键: " + MqConstants.HOTEL_INSERT_KEY);
        System.out.println("酒店ID: " + hotel.getId());
        rabbitTemplate.convertAndSend(MqConstants.HOTEL_EXCHANGE, MqConstants.HOTEL_INSERT_KEY, hotel.getId());
        System.out.println("=== [hotel-admin] MQ消息已发送 ===");
    }
